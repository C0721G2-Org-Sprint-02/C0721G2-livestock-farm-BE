...
//        return appUser;
    ...
    public void sendVerificationEmailForResetPassWord(String userName, String randomCode, String email) throws MessagingException, UnsupportedEncodingException {
        String subject = "Farm C0721G2 - Xác thực tài khoản của bạn";
        String mailContent = "";
        ...
        helper.setFrom("kukuku12113@gmail.com", "Tập đoàn chăn nuôi hàng đầu Châu Á C0721G2 Group");
        helper.setTo(email);
        ...
        mailContent = "<p style='color:red;font-size: 20px'>Xin chào " + userName + " ,<p>" + "<p style='font-size: 16px'> Nhấn vào link sau để thay đổi mật khẩu của bạn:</p>" +
                ...
                "            style=\"font-weight: bold; color: rgb(33, 33, 33); font-family: Helvetica, Arial, sans-serif; display: inline;\">Tập đoàn chăn nuôi hàng đầu Châu á C0721-G2 Group</span> <span\n" +
